...
export default function Footer() {
  return (
    <footer className="relative z-10 bg-white pt-20 pb-10 lg:pt-[120px] lg:pb-20 px-3 shadow-md">
            ...
            <div className="mb-10 w-full">
              ...
              <p className="text-body-color mb-7 text-base inline">
                <img
                  ...
                  className="inline"
                />
                <b> 1, Taiwo avenue, Evbuotubu Benin city.</b>
              </p>
              <br />
              <div className="mb-2 mt-2 text-dark flex items-center text-sm font-medium">
