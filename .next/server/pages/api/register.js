...
async function handler(req, res) {
    ...
    if (req.method === "POST") {
        ...
        try {
            ...
            let user = await _models_User__WEBPACK_IMPORTED_MODULE_1__/* ["default"].findOne */ .Z.findOne({
                email
            });
            if (user) {
            ...
            user = new _models_User__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z({
                name,
                email,
                password
            });
...
var __webpack_exports__ = __webpack_require__.X(0, [323], () => (__webpack_exec__(8307)));
