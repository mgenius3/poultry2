...
export default function Footer() {
  return (
    <footer class="relative z-10 bg-white pt-20 pb-10 lg:pt-[120px] lg:pb-20 mx-8">
        ...
        <div class="-mx-4 flex flex-wrap">
          <div class="w-full px-4 sm:w-2/3 lg:w-3/12">
            <div class="mb-10 w-full">
              ...
              <p class="text-body-color mb-7 text-base inline">
                <img
              ...
              <br />
              <p class="mb-2 mt-2 text-dark flex items-center text-sm font-medium">
          ...
          <div class="w-full px-4 sm:w-1/2 lg:w-3/12">
            <div class="mb-10 w-full">
              ...
              <p class="text-body-color text-base">&copy; 2023 riere farm</p>
            </div>
          </div>
        </div>
      </div>
